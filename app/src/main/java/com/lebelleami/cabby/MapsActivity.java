...
import com.lebelleami.cabby.utilities.Utils;
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    //locationLabel.setText(String.format(getResources().getString(R.string.lat_lng), currentLocation.getLatitude(), currentLocation.getLongitude()));
